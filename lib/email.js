  ...
  var data = {
    ...
    html: dedent`
      <div style="background: white; position: relative; margin: 4em auto; max-width: 600px; font-size: 1.5em;">
        ...
        <p style="color: #ff9000; margin: 1em 0 3em;">Vi har tagit emot din ansökan. Du kommer höra från oss igen när urvalet till Designstipendiet är beslutat, någon gång i början av juli 2025.</p>
      </div>
    `,
  };
