...
function email (fields) {
  var data = {
    ...
    subject: 'Din ansökan till Designstipendiet 2020',
    text: 'Tack för din ansökan! Du kommer höra från oss igen när urvalet till Designstipendiet är beslutat, någon gång runt 18 juni 2020.',
    html: dedent`
      <div style="background: white; position: relative; margin: 4em auto; max-width: 600px; font-size: 1.5em;">
        ...
        <p style="color: red; margin: 1em 0 3em;">Vi har tagit emot din ansökan. Du kommer höra från oss igen när urvalet till Designstipendiet är beslutat, någon gång runt 18 juni 2020. Här nedanför är din ansökan.</p>

        <div style="color: red; font-style: italic;">Vilken av de tre kurserna har du sökt?</div>
        ...
        <div style="color: red; font-style: italic;">Har du någon länk du vill visa oss? Kanske till din Instagram, portfolio, en spellista, eller en artikel du gillar</div>
        <div style="color: red; margin: 0.25em 0 2em;">
          ${fields['538718527']}<br>
