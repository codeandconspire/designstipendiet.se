      ...
      <div class="Intro" id="intro">
        ...
        <div class="Intro-blocks">
          <div class="Intro-year">
            <svg width="41" height="16" viewBox="0 0 41 16">
              <path fill="#000" d="M9.1 15l1.2-3-.2-.1c-.4.6-.7 1-1 1.2a3 3 0 01-1.4.2h-5A73 73 0 008 7.5c.8-1 1.2-2.2 1.2-3.4 0-1-.4-2-1.1-2.8A4 4 0 005 .2c-1 0-1.8.3-2.7 1C1.5 1.7.9 2.8.6 4.5H1c.3-.8.7-1.4 1-1.7a3 3 0 012.4-1.1c.8 0 1.5.3 2 .8.6.6.9 1.4.9 2.4 0 1.2-.5 2.5-1.4 3.8l-5.3 6v.2H9zm7.2.2c2.1 0 3.5-1.2 4.4-3.6a12 12 0 00-.4-8.8C19.3 1.1 18 .2 16.4.2c-1.8 0-3.1 1-4 2.7-.7 1.4-1 3-1 4.8 0 2.4.5 4.2 1.5 5.6.9 1.3 2 1.9 3.4 1.9zm.2-.6c-1.3 0-2.2-1-2.6-2.7-.3-1-.4-2.3-.4-4 0-1.7.1-3 .4-4.1.4-2 1.3-3 2.5-3s2 1 2.5 2.9c.2 1 .3 2.4.3 4.2 0 2.2-.2 3.8-.6 5-.4 1.1-1 1.7-2.1 1.7zm15 .4l1.1-3-.2-.1c-.4.6-.7 1-1 1.2a3 3 0 01-1.4.2h-5a73 73 0 005.3-5.8c.8-1 1.2-2.2 1.2-3.4 0-1-.4-2-1.1-2.8a4 4 0 00-3-1.1c-1 0-1.8.3-2.7 1-.9.6-1.5 1.7-1.8 3.4h.4c.3-.8.7-1.4 1-1.7a3 3 0 012.4-1.1c.8 0 1.5.3 2 .8.6.6.9 1.4.9 2.4 0 1.2-.5 2.5-1.4 3.8l-5.3 6v.2h8.5zm9.1 0v-.3c-.8 0-1.3-.1-1.6-.3-.3-.1-.4-.5-.4-1V.4.1h-.2l-4 2v.3l.9-.3.7-.1c.3 0 .5 0 .6.2v10.8c0 .6 0 1-.3 1.2-.3.2-.8.3-1.7.4v.3h6z" fill-rule="nonzero" stroke="none" stroke-width="1"/>
            </svg>
          </div>
