  ...
  createElement () {
    return html`
      <div class="Intro" id="intro">
        ...
        <div class="Intro-title"><h1><span>Design</span><span>stipendiet</span></h1></div>
        <div class="Intro-blocks">
          <div class="Intro-year">
            <svg viewBox="0 0 44 17">
              <path fill="#000" fill-rule="nonzero" d="M1.32 16.072a25.51 25.51 0 011.82-.07l1.163.002c1.675.018 5.432.092 5.537.092.096 0 .312-.024.36-.216.086-.583.27-1.108.62-1.89l.124-.27c.24-.456.144-.768-.072-.768-.12 0-.312.216-.48.408-.6.648-.96.816-1.68.936-.792.12-4.464.12-5.496.024-.06-.02-.103-.107-.074-.163l.026-.029c1.656-1.824 3-3.432 4.344-4.992.96-1.152 1.896-2.832 1.896-4.224 0-2.184-1.68-4.056-3.84-4.056-1.672 0-3.104.81-4.17 2.323l-.15.221c-.24.336-.312.576-.312.792 0 .096.192.336.264.336.084 0 .205-.129.41-.386l.094-.118c.576-.744 1.584-1.488 2.952-1.488 1.464 0 2.76.864 2.76 2.952 0 1.68-1.128 3.624-2.472 5.352l-.996 1.24c-.877 1.082-1.836 2.225-2.598 2.966l-.222.21c-.192.168-.36.408-.312.552.024.168.36.288.504.264zM17.028.856c-.912 0-1.56.24-2.208.648-1.512.96-2.904 3.336-2.904 7.2 0 3.072 1.32 7.512 4.92 7.584.72.024 1.512-.216 2.208-.672 1.344-.864 2.736-3.408 2.736-7.272l-.005-.326c-.078-2.635-1.11-7.162-4.747-7.162zm-.408.72c.48 0 .864.192 1.248.456.648.456 1.8 2.52 1.8 6.456 0 3.072-.384 4.944-.936 6l-.1.15c-.23.32-.797 1.002-1.46 1.002-2.448 0-3.24-4.56-3.24-7.224 0-3.552.648-5.064 1.224-5.928.504-.696.912-.912 1.464-.912zm6.708 14.496a25.51 25.51 0 011.82-.07l1.163.002c1.675.018 5.432.092 5.537.092.096 0 .312-.024.36-.216.086-.583.27-1.108.62-1.89l.124-.27c.24-.456.144-.768-.072-.768-.12 0-.312.216-.48.408-.6.648-.96.816-1.68.936-.792.12-4.464.12-5.496.024-.06-.02-.103-.107-.074-.163l.026-.029c1.656-1.824 3-3.432 4.344-4.992.96-1.152 1.896-2.832 1.896-4.224 0-2.184-1.68-4.056-3.84-4.056-1.672 0-3.104.81-4.17 2.323l-.15.221c-.24.336-.312.576-.312.792 0 .096.192.336.264.336.084 0 .205-.129.41-.386l.094-.118c.576-.744 1.584-1.488 2.952-1.488 1.464 0 2.76.864 2.76 2.952 0 1.68-1.128 3.624-2.472 5.352l-.996 1.24c-.877 1.082-1.836 2.225-2.598 2.966l-.222.21c-.192.168-.36.408-.312.552.024.168.36.288.504.264zM38.706.856c-.912 0-1.56.24-2.208.648-1.512.96-2.904 3.336-2.904 7.2 0 3.072 1.32 7.512 4.92 7.584.72.024 1.512-.216 2.208-.672 1.344-.864 2.736-3.408 2.736-7.272l-.005-.326c-.078-2.635-1.11-7.162-4.747-7.162zm-.408.72c.48 0 .864.192 1.248.456.648.456 1.8 2.52 1.8 6.456 0 3.072-.384 4.944-.936 6l-.1.15c-.23.32-.797 1.002-1.46 1.002-2.448 0-3.24-4.56-3.24-7.224 0-3.552.648-5.064 1.224-5.928.504-.696.912-.912 1.464-.912z"/>
            </svg>
          </div>
